...
Pendiente, y fuera de los CA por la sección «Fuera de alcance»: nada se ha ejercitado contra el proveedor real en ventana (el primer partido es el viernes 2026-09-25); `engine.db.test.ts` siembra su propio partido y hace rollback. El residual **R-SPEC-007-1 SATISFECHO por ADR-009** (aprobado 2026-09-21); la spec absorbió las cuatro precisiones como N-8..N-11 y ADR-009 las consolida.
